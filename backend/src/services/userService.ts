...
export async function registerWithEmailPassword(email: string, password: string, name?: string, role?: string): Promise<User> {
...
export async function findOrCreateUserByPhone(phone: string, name?: string, role?: string): Promise<User> {
